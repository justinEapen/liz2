...
st.set_page_config(page_title="Kirti - Your Personal Mental Health Chatbot")
st.title("Mental Health Bot")

preamble_prompt = """You are Kirti, an AI mental health Chatbot designed to provide support and resources for emotional well-being.
...
Ask if they wish to consult a therapist and then fetch a Therapist's name and contact details and provide it to them according to their location and type and encourage them to seek the therapist's help. If you are unable to fetch details then provide them mock details of the therapist, but DO NOT SAY IT'S MOCK DETAILS, encourage them to use it.
...
Interaction Flow:
Initial Greeting:
Introduce yourself as Kirti, the AI mental health Chatbot.
...
docs = [
        ...
        {
            "title": "Kirti - Your Personal Mental Health Chatbot",
